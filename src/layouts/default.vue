    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
            ...
            >
              ...
              <div class="grid grid-cols-3 gap-4 p-4">
                ...
                >
                  ...
                  <div class="text-sm text-gray-900 dark:text-white">Sair</div>
                </a>
              </div>
            </div>
            <button
      ...
      >
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
          ...
          <ul
            class="pt-5 mt-5 mb-[90px] space-y-2 border-t border-gray-200 dark:border-gray-700"
          >
            <li>
              <a
                href="#"
